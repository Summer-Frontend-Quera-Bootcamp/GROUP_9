...
const ProjectsDisplayList: React.FC<IProjectsDisplayProps> = ({ activePage = "BoardView" }): JSX.Element => {
    const Pages = [
        {
            name: "ListView",
            title: "نمایش لیستی",
            ...
            underline: <div className="absolute top-[62px] right-[115px] w-[120px] h-[3px] bg-Brand-Primary rounded-full"></div>
        },
        {
            name: "BoardView",
            title: "نمایش ستونی",
            ...
            underline: <div className="absolute top-[62px] right-[271px] w-[123px] h-[3px] bg-Brand-Primary rounded-full"></div>
        },
        {
            name: "CalenderView",
            title: "تقویم",
            ...
            underline: <div className="absolute top-[62px] right-[427px] w-[69px] h-[3px] bg-Brand-Primary rounded-full"></div>
        }
    ]
    return (
        <>
