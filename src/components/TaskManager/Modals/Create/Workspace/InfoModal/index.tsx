...
const InfoModal: React.FC<modalProps> = ({ isOpen, onClose, workSpaceName,color, handleBack, buttonClick }) => {
    ...
    return (
        <Modal activeModal={3} title={"مرور اطلاعات "} hasButton={true} onClose={onClose} isOpen={isOpen} isSlide={true} width={"501"} height={"369"} backButton={true} buttonTitle={"ساختن ورک‌اسپیس"} handleBack={handleBack} buttonClick={buttonClick}>
