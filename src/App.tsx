...
import Forgot from "./pages/Authentication Pages/Forget Password Page/forget.tsx";
    ...
    <Background text="قبلا ثبت‌ نام کرده‌ای؟" btn="ورود">
      <Form_base
        ...
        items={[
          ...
          { type: "password", name: "pass", label: "فامیلی" },
          { type: "email", name: "email", label: "ایمیل" },
        ]}
        schema={z.object({
          name: z
            .string()
            .min(3, { message: "حداقل تعداد کاراکتر3 تا میباشد" }),
          pass: z
            .string()
