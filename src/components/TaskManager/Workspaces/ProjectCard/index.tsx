...
const ProjectCard = ({ project, workspaceColor }: IProjectCardProps) => {
  return (
    <>
      <div
        className={`shadow-projectCart bg-gradient-to-l ${ColorList.get(
          String(workspaceColor)
        )
          ?.gradient} flex justify-center w-[200px] h-[80px] items-center mx-auto py-[26px] rounded-[16px] cursor-pointer`}
      >
