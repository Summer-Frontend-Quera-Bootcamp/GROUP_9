            ...
            <ul className="flex items-center justify-between divide-x gap-s ">
              ...
              <li
                className={`flex items-center justify-between pl-s gap-[5px] cursor-pointer ${
                  activeItem === "نمایش لیستی" ? "active" : ""
                }`}
                onClick={() => onItemSelect("نمایش لیستی")}
              >
              ...
              <li
                className={`flex items-center justify-between pl-s gap-[5px] cursor-pointer ${
                  activeItem === "نمایش ستونی" ? "active" : ""
                }`}
                onClick={() => onItemSelect("نمایش ستونی")}
              >
              ...
              <li
                className={`flex items-center justify-between pl-s gap-[5px] cursor-pointer ${
                  activeItem === "تقویم" ? "active" : ""
                }`}
                onClick={() => onItemSelect("تقویم")}
              >
                {activeItem === "تقویم"
                  ? activeCalendarIcon
                  : normalCalendarIcon}
