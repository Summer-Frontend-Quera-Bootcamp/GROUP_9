...
const Form_base: React.FC<Iform> = ({ title, items, schema, contranct = false, btn_text, forget = false, signup = false }): JSX.Element => {
    ...
    return (
        <div dir='rtl' className='shadow d-none w-[40rem] h-[auto] z-50 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-[20px] p-[24px] bg-white flex flex-col items-center justify-center'>
