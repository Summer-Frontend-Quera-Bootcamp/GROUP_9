...
const NewSpaceModal: React.FC<modalProps> = ({ isOpen, onClose, buttonClick, handleBack }) => {
    ...
    return (
        <ModalLayout activeModal={1} title={"ساختن ورک‌اسپیس جدید"} onClose={onClose} isOpen={isOpen} isSlide={true} width={"500"} height={"272"} backButton={false} buttonTitle={"ادامه"} buttonClick={buttonClick} handleBack={handleBack}>
