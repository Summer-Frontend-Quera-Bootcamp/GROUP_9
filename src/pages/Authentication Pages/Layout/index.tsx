...
const AuthenticationLayout: React.FC<IAuthenticationLayoutprops> = ({ buttonTextContent, linkTextContent, children}): JSX.Element => {
    return (
        <main className="w-full h-full pt-[80px] pb-0 px-[80px] flex flex-col justify-start items-center">
            ...
            <svg className="w-full fixed inset-x-0 -bottom-[125px] -z-1" viewBox="0 0 1440 574" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M0 260L1440 0V574H0V260Z" fill="url(#paint0_linear_2_981)"/>
              <defs>
                <linearGradient id="paint0_linear_2_981" x1="1440" y1="257.5" x2="-55" y2="287" gradientUnits="userSpaceOnUse">
