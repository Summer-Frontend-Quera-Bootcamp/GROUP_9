...
const NewTaskBtn: React.FC = (): JSX.Element => {
  ...
  return (
    <button onClick={handleclick} className={`w-[118px] fixed bottom-[30px] left-[50px] ${color?.bgPrimary} ${color?.hover} px-xs py-[12px] rounded-[6px] flex items-center gap-[4px] z-10`}>
      {TaskPlusButtonIcon}
