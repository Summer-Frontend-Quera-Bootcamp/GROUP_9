...
const Login: React.FC = (): JSX.Element => {
  return (
    <Authentication page="login">
      ...
      >
        <>
          <Link to={"/authentication/forgetpassword"} className="text-right font-IranYekan800 text-BoldXS text-Brand-Primary mt-xs cursor-pointer">
          ...
          <p className="mt-m text-center font-IranYekan500 text-BodyM">
            ثبت‌نام نکرده‌ای؟
            <span>
              <Link className="mr-[7px] text-Brand-Primary font-IranYekan800 text-BoldM" to={"/authentication/register"}>
                ثبت‌نام
              </Link>
            </span>
          </p>
